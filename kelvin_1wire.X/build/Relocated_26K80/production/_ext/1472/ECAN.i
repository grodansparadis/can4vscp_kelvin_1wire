...
# 18 "/home/akhe/.mchp_packs/Microchip/PIC18F-K_DFP/1.3.84/xc8/pic/include/xc.h"
...
# 52 "/home/akhe/.mchp_packs/Microchip/PIC18F-K_DFP/1.3.84/xc8/pic/include/proc/pic18f26k80.h"
...
# 18 "/home/akhe/.mchp_packs/Microchip/PIC18F-K_DFP/1.3.84/xc8/pic/include/pic18.h"
...
BSEL0 = 1 << 7 | 1 << 6 | 1 << 5 | 0 << 4 | 0 << 3 | 0 << 2;

# 295
RXF0SIDH = (long)0x00000000L >> 21L;RXF0SIDL = (((long)0x00000000L >> 13L) & 0xe0) | ((long)(0x00000000L) & 0x03L) | 0x08;RXF0EIDH = (long)0x00000000L >> 8L;RXF0EIDL = 0x00000000L;;

# 303
RXF1SIDH = (long)0x001E1A00L >> 21L;RXF1SIDL = (((long)0x001E1A00L >> 13L) & 0xe0) | ((long)(0x001E1A00L) & 0x03L) | 0x08;RXF1EIDH = (long)0x001E1A00L >> 8L;RXF1EIDL = 0x001E1A00L;;

# 428
RXFCON0 = (0 << 7) | (0 << 6) | (0 << 5) | (0 << 4) | (0 << 3) | (0 << 2) | (1 << 1) | (1);

# 436
RXFCON1 = (0 << 7) | (0 << 6) | (0 << 5) | (0 << 4) | (0 << 3) | (0 << 2) | (0 << 1) | (0);
...
# 481
RXM0SIDH = (long)0x01FF0000L >> 21L; RXM0SIDL = (((long)0x01FF0000L >> 13L) & 0xe0) | ((long)(0x01FF0000L) & 0x03L); RXM0EIDH = (long)0x01FF0000L >> 8L; RXM0EIDL = 0x01FF0000L;;
RXM0EXIDM = 1;

# 489
RXM1SIDH = (long)0x01FFFF00L >> 21L; RXM1SIDL = (((long)0x01FFFF00L >> 13L) & 0xe0) | ((long)(0x01FFFF00L) & 0x03L); RXM1EIDH = (long)0x01FFFF00L >> 8L; RXM1EIDL = 0x01FFFF00L;;
RXM1EXIDEN = 1;

# 498
ECANSetOperationMode(0x00);
...
_ECANRxFilterHitInfo.bits.b0 = RXB0FILHIT0;
...
else if ( (B0TXEN==0) && B0RXFUL )
ptr = (BYTE*)&B0CON;

else if ( (B1TXEN==0) && B1RXFUL )
ptr = (BYTE*)&B1CON;

else if ( (B2TXEN==0) && B2RXFUL )
ptr = (BYTE*)&B2CON;

else if ( (B3TXEN==0) && B3RXFUL )
ptr = (BYTE*)&B3CON;

else if ( (B4TXEN==0) && B4RXFUL )
ptr = (BYTE*)&B4CON;

else if ( (B5TXEN==0) && B5RXFUL )
ptr = (BYTE*)&B5CON;
...
if ( FIFOEMPTY == 1 )
{
ptr = (BYTE*)_ECANPointBuffer(CANCON&0x07);
...
while( (CANCON & ECAN_OP_MODE_BITS) != mode );
}
...
*ptr = Value->BYTES.BYTE_3 >> 5;
*ptr |= Value->BYTES.BYTE_4 << 3;
ptr++;
*ptr = (Value->BYTES.BYTE_3 << 3) & 0xE0;

*ptr |= 0b00001000;
*ptr |= Value->BYTES.BYTE_3 & 0x03;
ptr++;
*ptr = Value->BYTES.BYTE_2;
ptr++;
*ptr = Value->BYTES.BYTE_1;
}
}
...
Value->BYTES.BYTE_1 = (*ptr << 3);
Value->BYTES.BYTE_2 = *ptr >> 5;
ptr++;
Value->BYTES.BYTE_1 |= (*ptr >> 5);
...
Value->BYTES.BYTE_3 = (*ptr << 5);
Value->BYTES.BYTE_4 = (*ptr >> 3);
ptr++;
Value->BYTES.BYTE_3 |= (*ptr & 0x03);

Value->BYTES.BYTE_3 |= ((*ptr & 0xe0) >> 3);
ptr++;
Value->BYTES.BYTE_2 = *ptr;
ptr++;
Value->BYTES.BYTE_1 = *ptr;
}
}

...
# 1 "../../vscp-firmware/common/vscp-firmware.c"
...
# 7 "/opt/microchip/xc8/v2.31/pic/include/c90/stdlib.h"
...
# 104 "/opt/microchip/xc8/v2.31/pic/include/c90/stdlib.h"
...
# 219 "../../vscp-firmware/common/vscp-firmware.h"
typedef struct {
...
# 63 "../../vscp-firmware/common/vscp-firmware.c"
...
if ( 0 == vscp_nickname) vscp_nickname = 0xff;


if ( 0xff == vscp_nickname ) vscp_initledfunc = 0x02;
...
if ( ( 0x55 ==
vscp_getControlByte( 0 ) ) &&
( 0xAA ==
vscp_getControlByte( 1 ) ) ) {
return !0;
}
...
vscp_setControlByte( 0,
0x55 );
vscp_setControlByte( 1,
0xAA );
